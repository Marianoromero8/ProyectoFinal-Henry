...
const EditProducts = () => {
  ...
  const handleAddSize = () => {
    ...
    if (localProduct.sizes.includes(newSize)) {
      alert(`El talle ${newSize} ya existe. Por favor ingresa un talle diferente.`);
      return;
    }

    if (quantityStock > maxStock) {
      alert(`El stock no puede exceder de ${maxStock} unidades para el nuevo talle ${newSize}.`);
      return;
    }
      ...
      <div className={style.containerDatos}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={style.contTa}>
            ...
            />
            <button type="button" className={style.buttonProduct} onClick={handleAddSize}>
              Add Size
            </button>
          </div>
          <button type="submit" className={style.buttonProduct}>
